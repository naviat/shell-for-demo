...
class TestWaitForIt(unittest.TestCase):
    """
        TestWaitForIt tests the shell-for-demo.sh shell script.
        The shell-for-demo.sh script is assumed to be in the parent directory to
        the test script.
    """
    ...
    def setUp(self):
        ...
        self.wait_script = os.path.join(parent_path, "shell-for-demo.sh")
    ...
    def test_host_port(self):
        ...
        self.check_args(
            ...
            "",
            "shell-for-demo.sh: waiting 1 seconds for localhost:8929",
            0
        )
        soc.close()
    ...
    def test_combined_host_port(self):
        """
            Tests that shell-for-demo.sh returns correctly after establishing a
    ...
    def test_command_execution(self):
        ...
        self.check_args(
            ...
            "CMD OUTPUT",
            ".*shell-for-demo.sh: localhost:8929 is available after 0 seconds",
            0
        )
        soc.close()
